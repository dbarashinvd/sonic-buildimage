...
def get_num_asics():
    ...
    if asic_conf_file_path is None:
        ...
        #print("asic_conf_file_path is None, returning 1")
        return 1

    logger.log_notice("asic_conf_file_path: {}".format(asic_conf_file_path))
    #print("asic_conf_file_path: {}".format(asic_conf_file_path))
    with open(asic_conf_file_path) as asic_conf_file:
        ...
        logger.log_notice("returning num_asics: {}".format(num_asics))
        #print("returning num_asics: {}".format(num_asics))
